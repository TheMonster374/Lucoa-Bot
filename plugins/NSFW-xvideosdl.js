...
const handler = async (m, {conn, args, command, usedPrefix, text}) => {
  ...
  if (!args[0]) throw `*ingrese un enlace valido de xvideos, ejemplo: ${usedPrefix + command} https://www.xvideos.com/video70389849/pequena_zorra_follada_duro*`;
  try {
    conn.reply(m.chat, 'el video esta siendo procesado, espere un momento en lo que es enviado..\n\n﹣ ᴇʟ ᴛɪᴇᴍᴘᴏ ᴅᴇ ᴇɴᴠɪᴏ ᴅᴇᴘᴇɴᴅᴇ ᴅᴇʟ ᴘᴇsᴏ ʏ ᴅᴜʀᴀᴄɪᴏ́ɴ ᴅᴇʟ ᴠɪᴅᴇᴏ', m);
