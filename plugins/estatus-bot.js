...
conn.relayMessage(m.chat, { extendedTextMessage:{ text: wm, contextInfo: { externalAdReply: { title: '', mediaType: 1, previewType: 0, renderLargerThumbnail: true, thumbnailUrl: 'https://telegra.ph/file/ec8cf04e3a2890d3dce9c.jpg', sourceUrl: '' }}, mentions: [m.sender] }}, {})
...
handler.tags = ['bot']
handler.command = /^status|statusbot|botstatus$/i
