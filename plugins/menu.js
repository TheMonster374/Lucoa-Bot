...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
 try {
    ...
    conn.sendMessage(m.chat, { video: { url: [pp, pp2].getRandom() }, gifPlayback: true, caption: text.trim(), mentions: [m.sender] }, => conn.relayMessage(m.chat, { ptvMessage: m.quoted }, { quoted: m })
  } catch (e) {
