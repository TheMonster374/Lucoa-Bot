...
global.img10 = fs.readFileSync ('./src/Channel2.jpg');
  if (usedPrefix == 'a' || usedPrefix == 'A') return;
  try {
    const pp = img10
    const img = './src/Channel2.jpg';
  ...
  *✨¡ℍ𝕠𝕝𝕒 ${taguser}*
>------------[🤍]-------------<
¡Unete al canal oficial de *_INABAKUMORI-Bot [🤍]_* para estar atento a sus *actualizaciones*:
