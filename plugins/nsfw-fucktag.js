...
🤤🥵 *TREMENDA SORRA* 🥵🤤`, null, { mentions: [m.sender] });*/
        ...
        conn.sendFile(m.chat, url, '', '*🤤👅🥵 *TE COGISTES A ${mentionedUser}*🥵👅🤤 *¡${mentionedUser}!* HAS SIDO VIOLADO 😈🤤🥵 *¡QUE PERRA ERES* 🥵🤤`, null, { mentions: [m.sender] });*', m, false, { mimetype: 'image/jpeg' }); // Ajusta el mimetype según el tipo de archivo que obtienes de la API
