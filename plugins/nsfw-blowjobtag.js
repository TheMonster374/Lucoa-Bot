...
const handler = async (m, { conn, command, text }) => {
    try {
        ...
        conn.sendFile(m.chat, url, '', '', m, false, { mimetype: 'gif' }); // Ajusta el mimetype según el tipo de archivo que obtienes de la API   // Envía el texto mencionando al usuario con la imagen
