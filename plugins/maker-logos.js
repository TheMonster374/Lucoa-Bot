...
const handler = async (m, {conn, args: [effect], text: txt, usedPrefix, command, name}) => {
  ...
  await conn.sendMessage(m.chat, {image: {url: res.image}, caption: `*toma tu imagen pérsonalizada*\n*efecto: ${effect}*`}, {quoted: m});  
};
handler.help = ['logos'];
handler.tags = ['nulis'];
