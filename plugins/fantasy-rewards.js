...
await conn.reply(m.chat, `\`\`\`Desafío desbloqueado 🔓\`\`\`\n\n*${conn.getName(userId)} ahora puedes calificar personajes*`, null, m)
...
fake = { contextInfo: { externalAdReply: { title: `SIGUE DANDO ❤️`, body: `Califica personajes, es gratis ❤️`, sourceUrl: md, thumbnailUrl: imagen1 }}}
...
fake = { contextInfo: { externalAdReply: { title: `SIGUE DANDO 👎`, body: `Califica personajes, es gratis 😅`, sourceUrl: md, thumbnailUrl: imagen1 }}}
...
if (conditionMet) {
await conn.reply(m.chat, logro + `\n\n> Mira tus avances usando *#fymy*`, null, m)
