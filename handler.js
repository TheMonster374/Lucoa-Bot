...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '𝙄𝙉𝘼𝘽𝘼𝙆𝙐𝙈𝙊𝙍𝙄-𝘽𝙤𝙩', body: '🤍 Unete al grupo OFC', thumbnailUrl: 'https://i.imgur.com/yafZkFB.jpeg', sourceUrl: 'https://i.imgur.com/yafZkFB.jpeg'}}}}, aa);
