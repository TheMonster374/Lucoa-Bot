...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*Ingresa un texto para buscar, ejemplo: ${usedPrefix + command} Jotchua*`;
...
//conn.sendMessage(m.chat, {text: str.trim(), contextInfo: {forwardingScore: 9999999, isForwarded: true, mentionedJid: [m.sender], "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title": global.titulowm2, "containsAutoReply": true, "mediaType": 1, "thumbnail": imagen, "mediaUrl": `https://chat.whatsapp.com/LpZl6HC1iD3KfoYfDkyjbJ`, "sourceUrl": `https://chat.whatsapp.com/LpZl6HC1iD3KfoYfDkyjbJ`}}}, {quoted: m});  
};
