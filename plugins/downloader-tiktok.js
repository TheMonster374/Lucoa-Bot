...
if (!args[0]) return conn.reply(m.chat, `${JT.smsTT}\n\n${JT.smsEjemplo} : ${usedPrefix + command} https://www.tiktok.com/@catsparadise.1/video/7246312711640894746?is_from_webapp=1&sender_device=pc&web_id=7333552077824722438 .*`, m, estilo)
