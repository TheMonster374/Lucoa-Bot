...
if (!text) return conn.reply(m.chat, `🎌 *Ingrese una petición*\n\nEjemplo, !${command} Codigo en JS para un juego de cartas`, m, fakevoimg, ) 
  
try {

conn.sendPresenceUpdate('composing', m.chat)
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Alexis, tu seras Jotchua-Mini`
...
try {
let syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Alexis, tu seras Jotchua-Mini`
