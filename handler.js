...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*Advertencia*', body: 'ᴊᴏᴛᴄʜᴜᴀ - ʙᴏᴛ', thumbnail: imagen1, sourceUrl: 'https://github.com/AleXD0009/Jotchua-Bot'}}}}, aa);
