...
global.fake = { contextInfo: { mentionedJid: [owner[0][0] + '@s.whatsapp.net'], externalAdReply: { mediaUrl: false, mediaType: 1, description: '↷✦╎by als╎˖ ⸙', title: '𝑱𝒐𝒕𝒄𝒉𝒖𝒂-𝑩𝒐𝒕 | 𝑴𝑰𝑵𝑰',body: false, previewType: 0, thumbnail: catalogo, sourceUrl: ''}}}
