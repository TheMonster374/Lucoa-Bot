...
# Modificado por @AleXD0009

#!/data/data/com.termux/files/usr/bin/bash 
# Interpretación determinada para la ejecución     
COMANDOS = "pkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/AleXD0009/Jotchua-Bot\ncd Jotchua-Bot\nyarn install\nnpm install\nnpm start"
...
git clone https://github.com/AleXD0009/Jotchua-Bot.git
...
echo -e "\033[38;5;188m\033[01m🚀 Iniciando Jotchua-Bot!!\n\033[0m"
npm start
