...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   let txt = `_*< INFO - REPOSITORIO />*_\n\n`;
      ...
      txt += ` *URL:* ${json?.html_url || 'https://github.com/AleXD0009/Jotchua-Bot'}\n\n`;
      txt += `${json?.forks_count || '-'} Forks · ${json?.stargazers_count || '-'} Stars · ${json?.open_issues_count || '-'} Issues\n\n`;
      txt += `*Puedes descargar este repositorio enviando el comando:*\n_${usedPrefix}gitclone ${json?.html_url || 'https://github.com/AleXD0009/Jotchua-Bot'}_`;
   await conn.sendMessage(m.chat, {text: txt.trim(), mentions: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: {forwardingScore: 9999999, isForwarded: true, mentionedJid: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title": global.titulowm2, "containsAutoReply": true, "mediaType": 1, "thumbnail": imagen6, "mediaUrl": `https://chat.whatsapp.com/LpZl6HC1iD3KfoYfDkyjbJ`, "sourceUrl": `https://chat.whatsapp.com/LpZl6HC1iD3KfoYfDkyjbJ`}}}, {quoted: m});
};
